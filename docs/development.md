...
- Credential Readiness Dossier reports durable redacted issuance receipt state, source-freeze posture, homepage-vs-manifest source signals, proof commands, rehearsal decisions, and Swiggy/operator gates.
