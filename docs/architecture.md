...
- Generates `/api/production-launch-bundle` as the consolidated Swiggy handoff with proof artifacts, traffic readiness, Load Lab capacity simulation, Offer Intelligence savings safety, commands, access application fields, external gates, and a draft review email.
