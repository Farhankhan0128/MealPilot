...
15. Open Source Intelligence and Deep Site Map to show website, docs, API tool counts, CTA inventory, rendered page modules, header/footer links, proof paths, drift signals, and the next build queue in one reviewer-ready panel.
...
28. Open Production Evidence and show widgets, rate limits, Traffic Readiness, MCP Backpressure Governor, SLO Command, Data Governance, version monitor, compliance controls, Source Intelligence artifact, Deep Site Map artifact, Innovation Radar artifact, Launch Bundle, Trace Monitor, Runtime Telemetry, Audit Ledger, Resilience Lab, Evaluation Lab, and reviewer proof score.
