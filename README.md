...
- Reviewer Artifact Vault that packages proof links, OpenAPI, smoke commands, screenshot targets, Credential Readiness Dossier, Showcase Submission Center, redacted issuance state, demo-video checklist, logs, traces, redaction rules, support context, and Swiggy handoff copy into one access-submission manifest.
