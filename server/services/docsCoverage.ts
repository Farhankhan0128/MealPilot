...
const staticDocs: StaticDoc[] = [
  {
    ...
    mealPilotSurface:
      "README, Launch Center, Premium Use Case Studio, Visual Dish Capture, Voice Commerce, Website Atlas, and reviewer proof package the complete product story.",
    evidenceLinks: [
  ...
  },
  {
    ...
    mealPilotSurface:
      "Premium Use Case Studio, Journey Compiler, Visual Dish Capture, Voice Commerce, Planner, Demo Studio, widgets, preflight, and replay implement the recipe backbone.",
    evidenceLinks: [
      "/api/premium-use-case-studio",
