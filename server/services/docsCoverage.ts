...
const staticDocs: StaticDoc[] = [
  ...
  },
  {
    ...
    mealPilotSurface:
      "Resilience Lab, Error Intelligence, Support Bridge, SLO Incident Command, Runtime Telemetry, Traffic Readiness, Staging Certification Matrix, Staging Transcript Export, and Launch Bundle cover shipping proof.",
    evidenceLinks: [
      "/api/resilience",
  ...
  },
  {
    ...
    mealPilotSurface:
      "Access Dossier, Submission Package, Credential Cockpit, Data Governance Center, Traffic Readiness, Brand Compliance Kit, Builder Packet, and Launch Bundle prepare access review fields, volume, checks, rules, DPDP posture, legal readiness, and gates.",
    evidenceLinks: [
  ...
  },
  {
    ...
    mealPilotSurface:
      "Credential Cockpit, OAuth Status, Data Governance Center, PKCE start/callback, fail-closed gateway, and error intelligence cover auth posture and token redaction.",
    evidenceLinks: [
      "/api/credential-onboarding",
