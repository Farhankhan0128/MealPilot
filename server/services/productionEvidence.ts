...
export function buildReviewerProof(options: {
  ...
  return {
    ...
    artifacts: [
      ...
      { label: "Swiggy Builders Conversion Center", path: "/api/swiggy-conversion-center" },
      ...
      { label: "Swiggy Quality Loop Center", path: "/api/swiggy-quality-loop-center" },
      { label: "Swiggy Ritual Autopilot Center", path: "/api/swiggy-ritual-autopilot-center" },
      { label: "Swiggy Payment Truth Center", path: "/api/swiggy-payment-truth-center" },
      { label: "Swiggy Meal Window Intelligence", path: "/api/swiggy-meal-window-intelligence" },
      { label: "Swiggy Customization Studio", path: "/api/swiggy-customization-studio" },
      ...
      { label: "Swiggy Quota Negotiation Center", path: "/api/swiggy-quota-negotiation-center" },
      ...
      { label: "Swiggy Dineout Precision Center", path: "/api/swiggy-dineout-precision-center" },
