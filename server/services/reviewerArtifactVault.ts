...
export function buildReviewerArtifactVault(): ReviewerArtifactVault {
  ...
  return {
    ...
    assertions: [
      ...
      "Screenshot targets cover the planner, Launch Center, Deep Site Map, Luxury Experience Workspace, Production Evidence, Demo Studio, mobile layout, and widget fallbacks.",
