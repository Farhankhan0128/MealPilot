...
export async function buildSwiggyBuildersCoverageReceipt(options: {
  ...
  const rows: SwiggyBuildersCoverageReceiptRow[] = [
    ...
    row({
      ...
      expected: "69 reviewer screenshot targets",
      actual: `${visualQa.readyTargets}/${visualQa.totalTargets} ready targets`,
      actualCount: visualQa.readyTargets,
      expectedCount: 69,
      status: visualQa.totalTargets >= 69 && visualQa.readyTargets === visualQa.totalTargets ? "covered" : "watch",
  ...
  return {
    ...
    commands: [
      ...
      },
      {
        ...
        expectedSignal: "70 screenshot targets return no overflow issues",
      },
    ],
    assertions: [
